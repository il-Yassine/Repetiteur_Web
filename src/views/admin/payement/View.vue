      ...
      <div class="container mx-auto mt-12 px-5">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
          <div class="flex items-center">
            <h3
              class="text-3xl font-medium text-gray-900 dark:text-white font-serif px-3"
            >
              Mes paiements
            </h3>
          ...
          >
            ...
            <tbody v-if="this.payement.length > 0">
              <tr
                ...
                v-for="(matier, index) in this.payement"
                :key="index"
              >
                <td class="px-6 py-4">
                  {{ index + 1 }}
                ...
                <td class="px-6 py-4">
                  <span v-if="matier.status === 'Payer'" class="text-green-500"
                    >Payer</span
                  >
                  <span
                    v-else-if="matier.status === 'Impayer'"
                    class="text-red-500"
                    >Impayer</span
                  >
                ...
                <td class="px-6 py-4" v-if="matier.status === 'Impayer'">
                  <button
                    @click="open(matier.demande.tarification.prix, matier.id)"
