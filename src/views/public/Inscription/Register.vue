 ...
 <div class="bg-gray-300">
  ...
  <div class="box">
    <div class="card sm-5 " >
     ...
     <form @submit.prevent="saveStuden">
...
<!--       
     ...
     <div class="mb-6">
       ...
       <div class="flex justify-between">
         ...
         <button type="submit" @click="saveStudent"  class=" w-32 text-white bg-orange-600 hover:bg-orange-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-lg px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Enregistrer</button>
       </div>
 ...
 <br>
    ...
    <footer
    class="bg-neutral-10 text-center text-black dark:bg-black-600 dark:text-neutral-200 lg:text-left">
    <!-- <div
